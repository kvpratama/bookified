    ...
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
      ...
      <header className="text-center mb-16 animate-fade-in-up">
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="absolute inset-0 bg-accent-foreground/10 blur-2xl rounded-full" />
            <Logo size={64} className="relative animate-soft-pulse" />
          </div>
        </div>
        ...
        <p className="font-serif text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          A quiet space where your PDFs come alive. Upload your books and chat
          with an AI companion that understands your documents.
        </p>
      ...
      <div className="space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <section className="space-y-6 animate-fade-in-up delay-500">
